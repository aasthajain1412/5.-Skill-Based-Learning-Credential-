![image](https://github.com/user-attachments/assets/356d5473-91ef-442c-bd31-dac3388aced6)# Skill-Based Learning Credential System
...
### Installation
```bash
git clone https://github.com/your-repo/Skill-Based-Learning-Credential-System
...
#### Core Functions:
1. **`issueCredential()`** - Issue new credentials to learners
2. **`verifyCredential()`** - Verify credential authenticity and validity
3. **`registerIssuer()`** - Register as an authorized credential issuer

#### Utility Functions:
- `authorizeIssuer()` - Authorize registered issuers (owner only)
- `revokeCredential()` - Revoke issued credentials
- `getLearnerCredentials()` - Get all credentials for a learner
...
await contract.registerIssuer("John Doe", "Tech University");

// Issue a credential
await contract.issueCredential(
    learnerAddress,
    "Smart Contract Development",
    "Advanced Solidity programming and dApp development",
    4, // Proficiency level (1-5)
    31536000, // 1 year validity
    "QmHash..." // IPFS metadata hash
);

// Verify a credential
const [isValid, credential, issuer] = await contract.verifyCredential(credentialId);
```
...
- **Credential Struct**: Stores all credential information
- **Issuer Struct**: Manages issuer information and verification
- **Access Control**: Owner and authorized issuer modifiers
- **Event Logging**: Comprehensive event emission for transparency

### Security Features
- Input validation and sanitization
- Authorized issuer verification system
- Credential expiration management
- Revocation capabilities
- Owner-controlled platform governance
...
## Authors
- **Blockchain Development Team** - Initial work and platform architecture
...
![image](https://github.com/user-attachments/assets/356d5473-91ef-442c-bd31-dac3388aced6)
